...
that heavier weight becomes the weight I use for sets 1 and 2 for 8-10 reps.
...
* c = the amount of reps I'm able to do the exercise
  with 'b' lbs, and is thus the rep goal to beat
...
* number of reps that can be performed with that heavier weight for final set<br>
  ...
  and clicking to the targeted muscle group and part.
...
* the number of reps you should aim for in the current set<br><br>
  ...
  of the exercise, will start the timer for your rest period before the next set. If you have completed
